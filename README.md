...
|----------|-----|-------------|
| [sift](https://github.com/Luv-Goel/sift) → *merged* | `clawkit scan` | Duplicate file finder |
| [dotenv](https://github.com/Luv-Goel/dotenv) → *merged* | `clawkit dotenv` | .env file toolkit |
| [warden](https://github.com/Luv-Goel/warden) → *merged* | `clawkit integrity` | File integrity monitor |
| [perm](https://github.com/Luv-Goel/perm) → *merged* | `clawkit audit` | Security permissions auditor |
| [mark](https://github.com/Luv-Goel/mark) → *merged* | `clawkit markdown` | Markdown toolkit |
| [tally](https://github.com/Luv-Goel/tally) → *merged* | `clawkit data` | Tabular data CLI |
| [logsmith](https://github.com/Luv-Goel/logsmith) → *merged* | `clawkit logs` | Log forensics |
| [vault](https://github.com/Luv-Goel/vault) → *merged* | `clawkit secrets` | Secret scanner |
